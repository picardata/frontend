          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="pr-5">
                ...
                <div class="mt-5">
                  <nuxt-link to="/argon/dashboard" class="btn btn-neutral my-2">Explore Dashboard</nuxt-link>
        ...
        <div class="row row-grid align-items-center">
          ...
          <div class="col-md-6">
            <div class="pr-md-5">
              ...
              <nuxt-link to="/argon/pages/user" class="font-weight-bold text-warning mt-5">Explore pages</nuxt-link>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row row-grid align-items-center">
          ...
          <div class="col-md-6 order-md-1">
            <div class="pr-md-5">
              ...
              <nuxt-link to="/argon/widgets" class="font-weight-bold text-info mt-5">Explore widgets</nuxt-link>
            </div>
          </div>
        </div>
      </div>
