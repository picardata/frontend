    ...
    <div class="container-fluid mt--6">
      <div class="row card-wrapper">
        <div class="col-lg-4">
          ...
          <div class="card">
            <!-- Card image -->
            <img class="card-img-top" src="~/static/img/theme/img-1-1000x600.jpg" alt="Image placeholder">
            <!-- List group -->
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="~/static/img/theme/team-4.jpg" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-4">
          ...
          <card>
            <!-- Card body -->
            <a href="#!">
              <img src="~/static/img/theme/team-1.jpg"
        ...
        <div class="col-lg-4">
          ...
          <div class="card bg-dark text-white border-0">
            <img class="card-img" src="~/static/img/theme/img-1-1000x600.jpg" alt="Card image">
