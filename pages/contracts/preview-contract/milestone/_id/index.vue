                      ...
                      <div v-if="contractStatus == 1 || contractStatus == 2" class="card border p-4">
                        <div class="mr-3">
                          <div class="all-form-title bold-text form-field">
                            ...
                            <div class="contract-review-field-wrapper no-background">
                              <button type="button" class="btn btn-lg btn-primary btn-add next-btn signature-btn" v-bind:disabled="disableInvitationButton" @click.prevent="modals.contractorEmailInvitation = true">
                                Invite contractor
                              </button>
