        ...
        <div class="container-fluid mt--6">
          <div class="row mt-3">
            <div class="col-12 form-title-wrapper">
              ...
              <button type="button" class="btn btn-lg btn-primary btn-add next-btn hide-btn" @click.prevent="next">
                Next
              </button>
            </div>
          </div>
                ...
                <div class="mr-3">
                  <div class="all-form-title bold-text form-field">
                    ...
                    <div class="contract-review-field-wrapper">
                      ...
                      <span class="text-right text-date">{{startDate}}</span>
                    </div>
  ...
  methods: {
    async next () {
      await this.$axios.get(
        '/api/fixed/rate/contract/' + this.contractId + '/generate/pdf',
