<template>
  <div class="row picardata-form-index">
        ...
        <div class="container-fluid mt--6">
          <div class="row mt-3">
            <div class="col-12 form-title-wrapper">
              <span class="form-title">Fixed rate contract</span>
              ...
              <div class="card border p-4">
                <div class="mr-3">
                  <div class="all-form-title bold-text form-field">
                    ...
                    <div class="contract-review-field-wrapper no-background">
                      <button type="button" class="btn btn-lg btn-primary btn-add next-btn signature-btn" v-bind:disabled="disableInvitationButton" @click.prevent="modals.contractorSignature = true">
                        Invite contractor
                      </button>
                    </div>
                  </div>
                ...
                <div class="mr-3">
                  <div class="all-form-title bold-text form-field">
                    ...
                    <div class="contract-review-field-wrapper">
                      ...
                      <span class="text-right text-date">${{firstPaymentAmount}} <br/> {{this.firstPaymentTypeOptions[firstPaymentType].name}}</span>
                    </div>
      ...
      <div class="full-contract-details-wrapper">
        <div class="mr-3">
          <div class="all-form-title bold-text form-field">
            ...
            <p>{{company.name}}, Incorporation having its principal place of business at {{company.street}} {{company.city}} {{company.postalCode}}, email address: <b>(“Client”)</b>, and
    ...
    <modal :show.sync="modals.contractorSignature" size="lg" modal-classes="modal-contractor-invitation">
      <template slot="header">
      </template>
      <div class="full-contract-details-wrapper">
        <div class="mr-3">
              ...
              <form @submit.prevent="handleSubmit(post)">
                ...
                <ValidationProvider v-slot="{ errors }" mode="passive" rules="required" vid="contractorEmailAddress" name="Contractor email address">
                  <div class="all-form-title bold-text form-field">
                    ...
                    <textarea v-model="contractorEmailInvitationContent" type="text" class="form-input form-control" placeholder=""></textarea>
                    <span class="text-danger">{{ errors[0] }}</span>
                  </div>
                </ValidationProvider>
              </form>
...
export default {
  ...
  async asyncData (context) {
    return await context.app.$axios.$get('/api/fixed/rate/contract/' + context.route.params.id)
      .then((data) => {
        console.log(data)
        return data
      })
  ...
  methods: {
    async sendClientSignature () {
      ...
      this.$axios.$patch('/api/fixed/rate/contract/' + this.contractId, {
        ...
        isInvoiceSettingsCustomisable: this.isInvoiceSettingsCustomisable,
        ...
        firstPaymentType: this.firstPaymentType,
