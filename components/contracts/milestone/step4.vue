      ...
      <form @submit.prevent="handleSubmit(post)">
        ...
        <ValidationProvider v-slot="{ errors }" mode="passive" rules="required" vid="contractStep2.salaryFrequency" name="Payment Frequency">
          <div class="all-form-title bold-text form-field mb-4">
            ...
            <select v-model="contractStep4.typeOfContractDocument" class="form-control form-input" @change="toggleCustomContract($event)">
        ...
        <ValidationProvider v-slot="{ errors }" mode="passive" rules="required" vid="contractStep2.salaryFrequency" name="Payment Frequency">
          <div class="all-form-title bold-text form-field mb-4">
            ...
            <country-select v-model="contractStep4.contractorTaxResidence" :country="country" top-country="SG" class="form-control form-input" />
...
export default {
  ...
  methods: {
    ...
    handleCustomContractUpload (event) {
      this.contractStep4.customContract = event.target.files[0]
    },
    async post () {
      ...
      this.contract.customContract = this.contractStep4.customContract
      this.contract.contractorTaxResidence = this.contractStep4.contractorTaxResidence
      this.contract.typeOfContractDocument = this.contractStep4.typeOfContractDocument
