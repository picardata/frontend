    ...
    <div class="card border p-4">
      <div class="mr-3">
        <div class="all-form-title bold-text form-field">
          <span class="text-label"> Contract has been created </span><br/>
        </div>
      </div>
    </div>

    <div class="card border p-4 full-contract-details">
      <div class="mr-3">
        <div class="all-form-title bold-text form-field">
          <h3 class="contract-main-title mb-5">CONTRACTOR AGREEMENT</h3>

          <p>This Contractor Agreement <b>(“Agreement”)</b> is entered into as of October 2nd,
            2021 (the <b>“Effective Date”</b>), between:</p>

          <p>Chew Corp Limited, Incorporation having its principal place of business at Main
            Road #0958-2B, Singapore, Singapore, 928123, email address: <b>(“Client”)</b>, and
          ...
          state, zip], registered under the number [Registration Number] and email
            address: [email], <b>(“Contractor”)</b>.</p>

          <p>Client and Contractor desire to have Contractor perform services for Client,
          subject to and in accordance with the terms and conditions of this Agreement.
            NOW, THEREFORE, the parties agree as follows:</p>

          <p><b>1. SERVICES</b></p>
          <p><b>1.1. Statements of Work.</b> From time to time, Client and Contractor may execute
          ...
          <p><b>1.2. Performance of Services.</b> Contractor will perform the services described in
          ...
          law and any compliance policies drawn to Contractors’ attention insofar as they
            are applicable to independent contractors.</p>

          <p><b>1.3. Equipment and Facilities.</b> Unless otherwise provided in a Statement of Work,
          ...
          place and order in which Contractor will perform the Services in accordance with
            any milestones and/or timeline set forth in a Statement of Work.</p>

          <p><b>1.4. Subcontractors.</b> Contractor may appoint a suitably skilled substitute in
          ...
          use of such subcontractors including the reasonable cost of all instruction
            (necessitated by the subcontracting) for the sub-contractor.</p>

          <p><b>2. PAYMENT</b></p>

          <p><b>2.1. Fees.</b> As Contractor’s sole compensation for the performance of Services,
          ...
          expressly subject to Contractor’s completion of Services provided therein or
            achievement of certain milestones to Client’s reasonable satisfaction.</p>

          <p><b>2.2. Expenses.</b> Unless otherwise provided in the Statement of Work, Client will
          ...
          <p><b>2.3. Payment Terms.</b> The payment terms will be set forth in the Statement of
          Work. The parties will use their respective commercially reasonable efforts to
            promptly resolve any payment disputes.</p>

          <p><b>2.4.</b> Client acknowledges that Contractor has appointed Deel. Inc, a Delaware
          ...
          using a payment method supported by Deel or by one of Deel's Payment Service
            Providers, and the disbursement of those payments to Contractor.</p>

          <p><b>2.5.</b> Client agrees to make all payments to Contractor using one of the payment
          ...
          <p><b>3.1. Independent Contractor.</b> Contractor’s relationship with Client will be that of
          ...
          to any bonus, stock options, profit sharing, insurance or similar benefits; or any
            other end-of-service benefits payable to an employee or worker.</p>

          <p><b>3.2. No Authority.</b> Contractor will have no authority to enter into agreements that
          ...
          incur any liability on behalf of Client, and will make such absence of authority
            clear in its dealings with any third parties.</p>

          <p><b>3.3. Status.</b> This contract is one for the provision of services and not a contract of
          ...
          <p><b>3.4. Liability.</b> Contractor will be liable for and will indemnify Client for any loss,
          ...
          <p><b>3.5. Indemnification by Contractor.</b> Tax Liability Indemnification by Contractor.
          ...
          by Contractor of applicable law related to this Section 3.5, Contractor will
            indemnify Client for and in respect of:</p>

          <p class="sub-point">a. payment of all taxes, salaries, benefits, Employment Insurance and Quebec
          ...
          intentional misconduct; and</p>

          <p class="sub-point">b. any liability arising from any employment-related claim or any claim based
          ...
          other professionals) brought by Contractor or any subcontractor against
            Client arising out of or in connection with the provision of the Services.</p>

          <p><b>3.6. Set-off.</b> Client may, in its sole discretion, satisfy any of the indemnities set
          forth in Section 3.5 (in whole or in part) by way of deduction from any payments
            due to Contractor.</p>

          <p><b>3.7. No expectation of renewal.</b> Contractor agrees that they have no expectation
          ...
          representation regarding the renewal shall be valid and binding on Client unless
            recorded in writing and signed by both Parties.</p>

          <p><b>4. OWNERSHIP</b></p>

          <p><b>4.1. Disclosure of Work Product.</b> Contractor will, as an integral part of the
          ...
          <p><b>4.2. Ownership of Contractor Work Product.</b> Contractor agrees that all
          ...
          Contractor for this limited purpose, and agrees to execute a separate power of
            attorney for this purpose if instructed to do so by Client.</p>

          <p><b>4.3. Moral Rights.</b> To the fullest extent permitted by applicable law, Contractor
          ...
          or statutory law of any country in the world, or under any treaty, regardless of
            whether or not such right is called or generally referred to as a <b>“moral right.”</b></p>

          <p><b>4.4. Related Rights.</b> To the extent that Contractor owns or controls (in the present
          ...
          are covered by such Related Rights, to the extent necessary to enable Client to
            exercise all of the rights assigned to Client under this Agreement.</p>

          <p><b>4.5.</b> Contractor acknowledges that except as provided by law, no further fees or
          ...
          <p><b>4.6.</b> Nothing contained in this Agreement will be construed to preclude Client from
          ...
          to exercise any rights or privileges with respect to the Intellectual Property owned
            by or assigned to Client under this Agreement.</p>

          <p><b>4.7. Exploitation.</b> If any part of the Services or Intellectual Property or information
          ...
          information performed or provided hereunder, or any assigned rights (including
            any modifications, improvements and derivatives of any of them).</p>

          <p><b>5. CONFIDENTIAL INFORMATION</b></p>

          <p><b>5.1. Definition of Confidential Information.</b> For purposes of this Agreement, all
          ...
          <p><b>5.2. Economic Value of Confidential Information.</b> Contractor acknowledges that
          ...
          Contractor's obligations pursuant to its relationship with Client, Contractor will not
            make any duplication or other copy of Client’s Confidential Information.</p>

          <p><b>5.3. Non-Use and Non-Disclosure.</b> Contractor and/or its employees and/or any
          ...
          respective employees or related entities. Contractor’s obligations under this
            Section shall survive the expiration or termination of this Agreement.</p>

          <p><b>5.4. Former or Concurrent Client’s Confidential Information.</b> Contractor agrees
          ...
          affected by the Contractor to the services in connection with Contractor’s
            fulfillment of its obligations under this Agreement.</p>

          <p><b>5.5. Third Party Confidential Information.</b> Contractor recognizes that Client has
          ...
          subject to a duty on the Client’s part to maintain the confidentiality of such
            information and to use it only for certain limited purposes. Contractor agrees:</p>

          <p class="sub-point">a. that Contractor and/or its employees and/or any third party affected by the
          ...
          term of this Agreement and thereafter, a duty to hold all such confidential or
            proprietary information in the strictest confidence;</p>

          <p class="sub-point">b. to treat any such third-party confidential information as if it was Client’s
            Confidential Information; and</p>

          <p class="sub-point">c. not to disclose it to any person, firm, corporation or other entity or to use it
          except as necessary in carrying out the Services for Client consistent with
          Client’s agreement with such third party.</p>

          <p><b>5.6. Return of Materials.</b> All documents and other tangible objects containing or
          ...
          any copies of the above materials, and once returned to Client in full, Contractor
            shall delete or destroy any copies which have remained in its possession.</p>

          <p><b>6. DATA PROTECTION</b></p>

          <p><b>6.1.</b> To the extent that the nature of the Services requires Contractor to process
          ...
          as such term is defined under the laws of any territory with jurisdiction over this
            Agreement related to the protection of Personal Information.</p>

          <p><b>6.2.</b> Contractor will fully comply with any reasonable instructions from and on
          ...
          <p><b>6.3.</b> Without prejudice to the generality of this clause relating to data protection,
          Contractor will and ensures that its subcontractors and employees will:</p>

          <p class="sub-point"> a. cooperate fully with Client in order to enable Client to comply with its
          ...
          assessments, consultations with supervisory authority or regulators);</p>

          <p class="sub-point">b. implement and maintain appropriate technical and organisational measures
          ...
          <p class="sub-point">c. process any Personal Information disclosed to Contractor by or on behalf of
            Client only</p>

          <p class="sub-sub-point">i. for the purposes of providing the Services; and</p>
          <p class="sub-sub-point">ii. for the purposes for which that Personal Information was obtained
            and is processed by Client;</p>

          <p class="sub-point">d. immediately provide such evidence of Contractor’s compliance with
          Contractor’s obligations under Data Protection Laws as Client may from
            time to time reasonably request; and</p>

          <p class="sub-point">e. immediately upon notification by Client, take all appropriate action to
          enable Client to properly comply with any request from a data subject in
            relation to access to and/or rectification or erasure of Personal Information.</p>

          <p><b>6.4.</b> Contractor understands and agrees that Client may carry out monitoring of
          ...
          Client’s communications systems, wrongdoing or non-compliance with Client’s
            practices and procedures by Contractor, its employees or subcontractors.</p>

          <p><b>6.5.</b> Client will collect and process Contractor’s Personal Information in
            accordance with its privacy notice and applicable laws.</p>

          <p><b>7. WARRANTIES</b></p>

          <p><b>7.1. No Pre-existing Obligations.</b> Contractor represents and warrants that
          ...
          commitments) that would be in conflict or inconsistent with or that would hinder
            Contractor’s performance of Contractor’s obligations under this Agreement.</p>

          <p><b>7.2. Performance Standard and Compliance.</b> Contractor covenants that
          ...
          Services will be remedied by Contractor upon written notice to this effect by
            Client. Contractor will (and will ensure that any subcontractor will):</p>

          <p class="sub-point">a. comply with all applicable laws, regulations, codes and sanctions relating to
            anti-bribery and anti-corruption;</p>

          <p class="sub-point">b. promptly report to Client any request or demand for any undue financial or
          other advantage of any kind received by Contractor in connection with the
            performance of this Agreement;</p>

          <p class="sub-point">c. not engage in any activity, practice or conduct which would constitute
          either a tax evasion facilitation offence or a foreign tax evasion facilitation
            offence;</p>

          <p class="sub-point">d. promptly report to Client any request or demand from a third party to
          ...
          <p class="sub-point">e. comply with all applicable laws and policies notified to Contractor regarding
            a prohibition against discrimination, harassment and bullying; and</p>

          <p class="sub-point">f. as required, certify to Client in writing Contractor’s compliance with this
            clause.</p>

          <p><b>7.3. Non-infringement.</b> Contractor represents and warrants that Contractor Work
          ...
          Contractor Work Product is created, developed or supplied by Client or by a third
            party on behalf of Client.</p>

          <p><b>7.4. Competitive Activities.</b> Client acknowledges that Contractor provides
          ...
          <p><b>7.5. Non-Solicitation of Personnel.</b> During the term of this Agreement and for a
          ...
          <p><b>8.1. Term.</b> This Agreement will commence on the Effective Date and will remain in
          ...
          earlier in accordance with the terms of this Agreement or a Statement of Work, or
            this Section 8. This Agreement may be renewed an unlimited number of times.</p>

          <p><b>8.2. Termination for Breach.</b> Except as provided below, either party may
          ...
          <p class="sub-point">a. commits (or any of its subcontractors commits) any gross negligence or
          ...
          independent contractors (including relating to bribery, corruption, tax
            evasion, data protection, equality and diversity, and health and safety);</p>

          <p class="sub-point">b. commits (or any of its subcontractors commits) any bribery offense;</p>

          <p class="sub-point">c. commits (or any of its subcontractors commits) a local or foreign tax
            evasion facilitation offense;</p>

          <p class="sub-point">d. is wound-up or declared bankrupt or makes arrangements with or for the
          benefit of Contractor’s creditors or has a court administration order made
            against Contractor for the reimbursement of Contractor’s creditors.</p>

          <p><b>8.3. Termination for Convenience.</b> Either party may terminate this Agreement
          ...
          an individual Statement of Work at any time, without assigning any reason, upon
            at least ten (10) days written notice to Contractor.</p>

          <p><b>8.4. Termination of Deel Terms and Conditions.</b> This Agreement will
          ...
          either party, or in the event that Deel terminates Client’s or Contractor’s use of the
            Deel platform for any reason.</p>

          <p><b>8.5. Effect of Termination.</b> Upon the expiration or termination of this Agreement
          ...
          (iii) Client will pay Contractor any accrued but unpaid fees due and payable to
            Contractor pursuant to Section 2.</p>

          <p><b>8.6. Survival.</b> The rights and obligations of the parties under Sections 2, 3.2, 4, 5,
          ...
          <p><b>9.1.</b> Nothing in this Agreement will exclude or limit either party’s liability for losses
          ...
          contractor breach of the warranty of non infringement under Section 7.3; or a
            party’s breach of applicable law.</p>

          <p><b>9.2.</b> Subject to the provisions above, neither party will be liable in contract, tort
          ...
          (other than fraudulent misrepresentation) or otherwise arising out of or in
            connection with this Agreement for:</p>

          <p class="sub-point">a. any economic losses (including, without limitation, loss of revenues, profits,
          contracts, data, business, anticipated savings or cost of substitute
            services);</p>

          <p class="sub-point">b. any loss of goodwill or reputation; or</p>

          <p class="sub-point">c. any special, indirect or consequential losses suffered or incurred by a party
          ...
          the Agreement; whether or not such losses were within the contemplation of
            the parties on the Effective Date.</p>

          <p><b>IN NO EVENT WILL EITHER PARTY BE LIABLE FOR ANY SPECIAL, INCIDENTAL,
          ...
          LIABILITY WILL NOT EXCEED THE UNDISPUTED OUTSTANDING BALANCES
            OWED TO CONTRACTOR.</b></p>

          <p><b>10. GENERAL</b></p>

          <p><b>10.1. Assignment.</b> Contractor may not assign, transfer or delegate this
          ...
          <p><b>10.2. No Election of Remedies.</b> Except as expressly set forth in this Agreement,
          ...
          deemed an election of remedies and will be without prejudice to its other
            remedies under this Agreement or available at law or in equity or otherwise.</p>

          <p><b>10.3. Equitable Remedies.</b> Because the Services are personal and unique and
          ...
          <p><b>10.4. Attorneys’ Fees.</b> If any action is necessary to enforce the terms of this
          ...
          attorneys’ fees, costs and expenses in addition to any other relief to which such
            prevailing party may be entitled.</p>

          <p><b>10.5. GOVERNING LAW.</b> THIS AGREEMENT WILL BE GOVERNED BY AND
          ...
          <p><b>10.6. Severability.</b> If any provision of this Agreement is held invalid or
          unenforceable by a court of competent jurisdiction, the remaining provisions of
          this Agreement will remain in full force and effect, and the provision affected will
            be construed so as to be enforceable to the maximum extent permissible by law.</p>

          <p><b>10.7. Waiver.</b> The failure by either party to enforce any provision of this
          Agreement will not constitute a waiver of future enforcement of that or any other
            provision.</p>

          <p><b>10.8. Notices.</b> All notices required or permitted under this Agreement will be in
          ...
          to such other e-mail address as may be specified by either party to the other
            party in accordance with this Section 10.8.</p>

          <p><b>10.9. Entire Agreement.</b> This Agreement, together with all Statements of Work,
          ...
          <p><b>10.11. Counterparts.</b> This Agreement may be executed in counterparts, each of
          which will be deemed an original, but all of which together will constitute one and
            the same instrument.</p>

          <p><b>10.12. Modifications.</b> This Agreement may be modified only by a contract in
          writing executed by the parties to this Agreement against whom enforcement of
            such modification is sought.</p>

          <p><b>10.13. Third-Party Rights.</b> The parties do not intend that any term of this
          Agreement will be enforceable by any person who is not a party to this
            Agreement.</p>

          <p><b>10.14. Electronic Signatures.</b> Except where prohibited by law, the parties
          consent to use Deel’s electronic signature service to execute this Agreement and
            agree that such signatures are valid and binding on the parties.</p>

          <p>IN WITNESS WHEREOF, the parties have executed this Agreement as of the
            Effective Date.</p>

          <div class="mt-5 signature-wrapper">
              ...
              <form @submit.prevent="handleSubmit(post)">
                <ValidationProvider v-slot="{ errors }" mode="passive" rules="required" vid="clientSignature" name="Client signature">
                  <div class="all-form-title bold-text form-field float-left">
                    ...
                    <input v-model="clientSignature" type="text" class="form-input form-control form-signature" placeholder="">
            ...
            <div class="all-form-title bold-text form-field float-right">
              ...
              <input type="text" class="form-input form-control form-signature" placeholder="" disabled>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="mr-3">
        <div class="all-form-title bold-text form-field">
          ...
          <div class="contract-review-field-wrapper">
            ...
            <span class="text-right text-date">27 September 2021</span>
          </div>

          <div class="contract-review-field-wrapper">
            <span class="text-left">Contractor Type</span>
            <span class="text-right text-date">Fixed Rate</span>
          </div>

          <div class="contract-review-field-wrapper">
            <span class="text-left">Entity Name</span>
            <span class="text-right text-date">{{contract.legalEntity}}</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="mr-3">
        <div class="all-form-title bold-text form-field">
          ...
          <div class="contract-review-field-wrapper">
            ...
            <span class="text-right text-date">{{contract.jobTitle}}</span>
          </div>

          <div class="contract-review-field-wrapper">
            <span class="text-left">Seniority Level</span>
            <span class="text-right text-date">{{this.seniorityLevels[contract.seniorityLevel].name}}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card border p-4">
      <div class="mr-3">
        <div class="all-form-title bold-text form-field">
          ...
          <div class="contract-review-field-wrapper">
            <span class="text-left">{{contract.scopeOfWork}}</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="mr-3">
        <div class="all-form-title bold-text form-field">
          ...
          <div class="contract-review-field-wrapper">
            ...
            <span class="text-right text-date">{{contract.salaryCurrency}} {{contract.salaryAmount}} per {{this.salaryFrequencies[contract.salaryFrequency].name}}</span>
          </div>

          <div class="contract-review-field-wrapper">
            <span class="text-left">Invoice cycle ends</span>
            <span class="text-right text-date">{{this.invoiceCycleEndsOptions[contract.invoiceCycleEnds].name}}</span>
          </div>
        </div>
      </div>
    </div>
