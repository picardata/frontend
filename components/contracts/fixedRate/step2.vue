  ...
  <div class="mr-3">
    <ValidationObserver ref="form" v-slot="{ handleSubmit }" @keyup="onFormChange">
      <form @submit.prevent="handleSubmit(post)">
        ...
        <ValidationProvider v-slot="{ errors }" mode="passive" rules="required" vid="contract.salaryAmount" name="Salary Amount">
          <div class="all-form-title bold-text form-field two-colls first-coll">
            <span class="text-label">How much?</span>
            <input v-model="contract.salaryAmount" type="text" class="form-input form-control" placeholder="">
            <span class="text-danger">{{ errors[0] }}</span>
          </div>
        </ValidationProvider>

        <ValidationProvider v-slot="{ errors }" mode="passive" rules="required" vid="contract.salaryCurrency" name="">
          <div class="all-form-title bold-text form-field two-colls">
            <span class="text-label">Currency</span>
            <select v-model="contract.salaryCurrency" class="form-control form-input">
        ...
        <ValidationProvider v-slot="{ errors }" mode="passive" rules="required" vid="contract.salaryFrequency" name="">
          <div class="all-form-title bold-text form-field">
            <span class="text-label">Per</span>
            <select v-model="contract.salaryFrequency" class="form-control form-input">
        ...
        <ValidationProvider v-slot="{ errors }" mode="passive" rules="required" vid="contract.salaryAmount" name="Salary Amount">
          <div class="all-form-title bold-text form-field">
            ...
            <base-switch class="mr-1 form-checkbox" on-text="Yes" off-text="No" v-model="contract.isInvoiceSettingsCustomisable"></base-switch>
            <span class="text-danger">{{ errors[0] }}</span>
          </div>
        </ValidationProvider>

        <ValidationProvider v-slot="{ errors }" mode="passive" rules="required" vid="contract.invoiceCycleEnds" name="">
          <div class="all-form-title bold-text form-field">
        ...
        <ValidationProvider v-slot="{ errors }" mode="passive" rules="required" vid="contract.invoicePaymentDue" name="">
          <div class="all-form-title bold-text form-field">
            <span class="text-label">Payment due</span>
            <select v-model="contract.invoicePaymentDue" class="form-control form-input">
        ...
        <ValidationProvider v-slot="{ errors }" mode="passive" rules="required" vid="contract.isInvoicePaymentPayAheadOfTheWeekend" name="">
          <div class="all-form-title bold-text form-field">
            ...
            <base-switch class="mr-1 form-checkbox" on-text="Yes" off-text="No" v-model="contract.isInvoicePaymentPayAheadOfTheWeekend"></base-switch>
            <span class="text-danger">{{ errors[0] }}</span>
          </div>
        </ValidationProvider>
      </form>
